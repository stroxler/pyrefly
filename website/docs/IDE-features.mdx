...
Right now, Pyrefly does not work with Jupyter notebooks in VS Code. Please follow [this issue](https://github.com/facebook/pyrefly/issues/381) for updates.

You may use Pyrefly with Jupyter notebooks in Jupyter Lab, via the [jupyterlab-lsp](https://jupyterlab-lsp.readthedocs.io/en/latest/Installation.html) extension. Pyrefly will appear on the list of automatically-detected language servers.
