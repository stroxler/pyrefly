...
Manually adding type annotations to your code can be tedius and time-consiming. Pyrefly can help with this task by automatically adding type annotations to your code.
