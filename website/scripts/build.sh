...
# This should be a singular script which does everything needed to build the Pyrefly website locally. To serve the build
# we need to run yarn build. We expect install.sh before this to install all the dependencies needed to run the website first.
