...
from typing import Any, Callable, cast, Generic, Literal, NoReturn
...
from ._generics import get_model_typevars_map, PydanticGenericMetadata
...
class ModelMetaclass(ABCMeta):
    ...
    if not typing.TYPE_CHECKING:  # pragma: no branch
        ...
        def __getattr__(self, item: str) -> Any:  # noqa
    ...
    @classmethod
    def __prepare__(cls, *args: Any, **kwargs: Any) -> dict[str, object]:  # noqa
        return _ModelNamespaceDict()

    def __instancecheck__(self, instance: Any) -> bool:  # noqa
    ...
    def __subclasscheck__(self, subclass: type[Any]) -> bool:  # noqa
    ...
    def __fields__(self) -> dict[str, FieldInfo]:  # noqa
        warnings.warn(
            "The `__fields__` attribute is deprecated, use `model_fields` instead.",
    ...
    @property
    def __pydantic_fields_complete__(self) -> bool:  # noqa
    ...
    def __dir__(self) -> list[str]:  # noqa
